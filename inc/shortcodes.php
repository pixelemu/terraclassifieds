				...
				<?php if ( get_option( 'users_can_register' ) ) : // register form ?>
					...
					<div id="terraclassifieds-register">
						...
						<form action="" id="terraclassifieds-signup-form" method="post">
							...
							<!--<p class="register-website">
								<label for="user_website"><?php esc_html_e( 'Website', 'terraclassifieds' ) ?></label>
								<input size="30" type="text" id="user_website" name="user_url" />
							</p>
							
							<p class="register-phone">
								<label for="user_phone"><?php esc_html_e( 'Phone', 'terraclassifieds' ) ?></label>
								<input size="30" type="text" id="user_phone" name="tc_phone" />
							</p>
							
							<p class="register-biographical-info">
								<label for="description"><?php esc_html_e( 'About me', 'terraclassifieds' ) ?></label>
								<textarea size="30" type="text" id="description" name="description" /></textarea>
							</p>-->
